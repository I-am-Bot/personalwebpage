...
export default function SinglePost() {
    ...
    return (
        <main className="bg-gray-800 min-h-screen p-12">
            <article className="container shadow-lg mx-auto bg-gray-700 rounded-lg">
                <header className="relative">
                    <div className="absolute h-full w-full flex items-center justify-center p-8">
                        <div className="bg-white bg-opacity-75 rounded p-12">
                            <h1 className="crusive text-3xl lg:text-6xl mb-4">
                                {SinglePost.title}
                            </h1>
                            ...
                            <p className="justify-center flex pl-2 text-1xl">
                                {SinglePost.name}
                            </p> 
                        </div>
                    </div>
                ...
                <div className="px-16 lg:px-48 py-12 lg:py-20 prose lg:prose-xl max-w-full text-white">
                    <BlockContent blocks={SinglePost.body} projectId="985hlruw" dataset="newdata"/>
                </div>
            </article>
        </main>
    )
